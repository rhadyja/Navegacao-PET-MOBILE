package com.example.bottonnavegantion.activity;
...
public class EolicoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eolico);

        imageView = findViewById(R.id.image);

        String arquivo = "Eolico.txt"; //passando nome do arquivo, que está no assets, que deseja fazer a navegação
